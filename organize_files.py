...
if __name__ == "__main__":
    ...
    parser.add_argument("mode", help="if \"combine\" we just combine dev and train sets. if merge_versions, we make a all directory from multiple versions of data")
    ...
    parser.add_argument("--apply_changes", help="apply changes to directory. otherwise, does dry run", action="store_true")
    ...
    if args.mode == "merge_versions":
        config = util_funcs.config #this is terrible. pls forgive me
        raise Exception("NOT IMPLEMENTED")
