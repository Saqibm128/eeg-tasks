...
@ex.capture
def get_model(g_noise, num_cnn_layers, loss_weights, num_lstm_layers, num_lin_layers, lstm_h, cnn2d_n_k, lin_h, lr):
...
def config():
    ...
    model_name = "/n/scratch2/ms994/" +  util_funcs.randomString() +".h5"
